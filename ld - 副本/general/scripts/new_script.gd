...
@export_range(480,65536,32,"suffix:px") var width : int = 480 : set = _on_width_changed
@export_range(270,65536,32,"suffix:px") var height : int = 270 : set = _on_height_changed
